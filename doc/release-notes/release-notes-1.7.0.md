...
Where previously commands were sent to lebowskiscoind by running
"lebowskiscoind <command>", 1.7 adopts the model from Bitcoin Core 0.9 where there is
a separate "lebowskiscoin-cli" executable which is used instead. This avoids the risk
