# Contributing to BoskaCoin Core

BoskaCoin Core is open source software, and we would welcome contributions
...
BoskaCoin Core's default branch is intentionally a stable release, so that anyone
...
BoskaCoin Core is a direct fork of Bitcoin Core and therefore benefits from as
