...
const char * const BITCOIN_CONF_FILENAME = "boskacoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "BoskaCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/BoskaCoin";
#else
    // Unix
    return pathRet / ".boskacoin";
#endif
#endif
}
