...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s lebowskiscoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  lebowskiscoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded lebowskiscoin transaction") + "\n" +
              "  lebowskiscoin-tx [options] -create [commands]   " + _("Create hex-encoded lebowskiscoin transaction") + "\n" +
              "\n";
