...
// Copyright (c) 2013 LebowskisCoin Developers
// Copyright (c) 2026 BoskaCoin Developers
...
CAmount GetDogecoinBlockSubsidy(int nHeight, CAmount nFees, const Consensus::Params& consensusParams, uint256 prevHash)
{
    ...
    if(rand > 30000 && rand < 35001)
        nSubsidy = 200 * COIN; // 5% chance
    else if(rand > 70000 && rand < 71001)
        nSubsidy = 500 * COIN; // 1% chance
    else if(rand > 50000 && rand < 50011)
        nSubsidy = 2500 * COIN; // 0.1% chance
    else if(rand == 77777)
        nSubsidy = 10000 * COIN; // 0.01% chance
