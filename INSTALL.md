# Installing BoskaCoin Core

### Pre-compiled binaries

The easiest way to install the latest version of the BoskaCoin Core software is
...
It is possible to build your own copy of BoskaCoin Core with the exact, tested,
...
BoskaCoin Core is a multithreaded application, and deadlocks or other multithreading bugs
